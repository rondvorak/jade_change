...
/*				ff.setAttribute('class','smoke-base'); */
	...
	build: function (e, f , rdy,bg) {
		...
		if (!smoke.init){		
			smoke.listen(window,"load", function(){
				smoke.finishbuild(e,f,box,rdy,bg);
			});
		} else{
			smoke.finishbuild(e,f,box,rdy,bg);
		}
	...
	finishbuild: function(e, f, box ,rdy,bg) {
...
/*				box.setAttribute('class','smoke-base'); */
    ...
    SmokeAlarm.emit('destroy',box,id);
